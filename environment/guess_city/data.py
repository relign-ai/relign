...
import nltk
import math
from environment.environment_base import Text, TextHistory, TextTrajectory, Reward, Done, History
...
def create_trajectory_from_conversation(conversation: Conversation, max_conversation_len: int=20, recompute_done: bool=False) -> TextTrajectory:
    ...
    return TextTrajectory(history=History(history=tuple(text_history)), reward=reward, done=done_flag)
