...
from environment.environment_base import Env, TextHistory, Reward, Done, Text
from environment.guess_city.oracle import GuessCityOracle
from environment.guess_city.data import create_trajectory_from_history, INITIAL_STR
from environment.factory import EnvironmentFactory

class GuessCityPolicyEnvironment(Env[TextHistory]):
    def __init__(self, 
