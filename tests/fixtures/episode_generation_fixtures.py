...
@pytest.fixture(
    params=episode_gen_configs, ids=["full_ds_inference", "sample_5_with_replacement"]
)
...
def math_episode_generator(
    ...
    return MathEpisodeGenerator(
        ...
        dataset_num_samples_per_iteration=episode_gen_config[
...
def math_grouped_episode_generator(
    ...
    question_template = """
        ...
        Solution:
    """
    cot_cls, cot_kwargs = cot_inference_strategy
    return MathEpisodeGeneratorGroupedRewards(
        ...
        dataset_sample_with_replacement=episode_gen_config[
        ...
        max_question_length=episode_gen_config["max_question_length"],
        reward_function=math_reward_function,
        inference_strategy_cls=cot_cls,
        inference_strategy_kwargs=cot_kwargs,
